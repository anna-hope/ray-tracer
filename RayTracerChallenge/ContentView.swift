...
struct ContentView: View {
    ...
    VStack {
        HStack {
            ...
            VStack {
                ...
                TextField("Velocity y",
                          text: $velocity_y)
                TextField("Velocity z",
                          text: $velocity_z)
            }.padding()
        }
        ...
        Button("Run simulation", action: runSimulation).keyboardShortcut(/*@START_MENU_TOKEN@*/.defaultAction/*@END_MENU_TOKEN@*/)
    ...
    private func runSimulation() {
        let position = Point(x: Double(self.position_x)!,
